...
public class PhenotypeExecutorTest {
    ...
    @Mock
    private MockEhrService mockEhrService;
    ...
    public void shouldCorrectlyExecuteOrNotPhenotype() {
        ...
        GroupExpression notNode = GroupExpression.builder().operator(Operator.NOT).children(Arrays.asList(notAql)).build();
        GroupExpression query = GroupExpression.builder().operator(Operator.OR).children(Arrays.asList(aqlExpression1, notNode)).build();
    ...
    public void shouldCorrectlyExecuteAndNotPhenotype() {
        ...
        GroupExpression notNode = GroupExpression.builder().operator(Operator.NOT).children(Arrays.asList(notAql)).build();
        GroupExpression query = GroupExpression.builder().operator(Operator.AND).children(Arrays.asList(aqlExpression1, notNode)).build();
