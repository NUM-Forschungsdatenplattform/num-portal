...
public enum SetupType {
  ...
  public enum Preprod {
    ...
    KEYCLOAK("https://keycloak.pre-prod.num-codex.de/auth");
    private String URL;
  }
  ...
  public enum Prod {
    ...
    KEYCLOAK("https://keycloak.crr.num-codex.de/auth");
    private String URL;
  }
  ...
  public enum Dev {
    ...
    KEYCLOAK("https://keycloak.dev.num-codex.de/auth");
    private String URL;
  }
  ...
  public enum Staging {
    ...
    KEYCLOAK("https://keycloak.staging.num-codex.de/auth");
    private String URL;
  }
}
