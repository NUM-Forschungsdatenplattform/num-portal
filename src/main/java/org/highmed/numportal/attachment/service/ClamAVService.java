...
import org.highmed.numportal.properties.ClamAVProperties;
            ...
            if (ins.available() > 0) {
              ...
              if (isSizeLimitException(replyResponse)) {
                throw new SystemException(
                    ClamAVService.class, "Scan aborted due to INSTREAM size limit exceeded. Check the value for ClamAV property 'StreamMaxLength'",
