...
public class CohortDto {
  ...
  @ApiModelProperty(required = true, value = "The name of the cohort")
  @NotBlank(message = "Cohort name should not be blank")
  @NotNull(message = "Cohort name is mandatory")
  private String name;

  @ApiModelProperty(value = "The description of the cohort")
  private String description;

  @ApiModelProperty(required = true, value = "Reference to the project")
  @NotNull(message = "Id of the project is mandatory")
  private Long projectId;

  @ApiModelProperty(required = true, value = "Aql cohort groups")
