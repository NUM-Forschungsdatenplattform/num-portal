...
public class CohortDto {
  ...
  @Schema(required = true, description = "The name of the cohort")
  ...
  @Schema(required = true, description = "Reference to the project")
  @NotNull(message = "Id of the project is mandatory")
  private Long projectId;

  @Schema(required = true, description = "Aql cohort groups")
